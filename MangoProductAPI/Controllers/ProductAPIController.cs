...
namespace Mango.Services.ProductAPI.Controllers
{
    ...
    public class ProductAPIController : ControllerBase
    {
        ...
        //    try
        //    {
        //        Product obj = _db.Products.FirstOrDefault(u => u.ProductCode.ToLower() == code.ToLower());
        //        if(obj == null)
        //        {
        //            _response.IsSuccess = false;
        //        }
        ...
        public ResponseDto Post([FromForm]ProductDto ProductDto)
        {
            try
            {
                ...
                if(ProductDto.Image != null)
                {
                    ...
                    using(var fileStram = new FileStream(filePathDirectory,FileMode.Create))
                    {
                        ProductDto.Image.CopyTo(fileStram);
                    }
